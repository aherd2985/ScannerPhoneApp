...
extern void *mono_aot_module_QuickCodeScanneriOS_info;
...
extern void *mono_aot_module_CodeScanner_info;
...
{
	mono_aot_register_module (mono_aot_module_QuickCodeScanneriOS_info);
	...
	mono_aot_register_module (mono_aot_module_CodeScanner_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "QuickCodeScanneriOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
